...
public class VerifyIfMailSentWhenVacationIsRejectedTest {
    ...
    @Test
    public void verifyIfMailSentWhenVacationIsRejected(){
    	...
    	approveRejectSteps.rejectTheSelectedRequest("Pop Irina","02/12/2015","02/12/2015","Vacation Without Payment");
