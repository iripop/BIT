...
public class Constants {
	public static final String defaultURL = "http://172.22.4.88:9091/login";
	public static final String DMname = "bianca.ianc1";
	public static final String DMpassword = "cana";
	public static final String DMlastName = "Bianca";
